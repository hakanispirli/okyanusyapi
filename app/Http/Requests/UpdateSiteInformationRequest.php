...
class UpdateSiteInformationRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'footer_logo' => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp,svg', 'max:2048'],
            'favicon' => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp,svg,ico', 'max:1024'],
