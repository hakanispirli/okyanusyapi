...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="max-w-lg mx-auto text-center">
        ...
        <!-- Error Code -->
        <div class="text-5xl font-bold text-primary-500 mb-3">429</div>

        <!-- Error Title -->
        <h1 class="text-2xl font-bold text-gray-900 mb-3">Çok Fazla İstek</h1>
        ...
        <div class="mt-6 text-sm text-gray-500">
            <p>Bu hata genellikle geçicidir. Birkaç dakika sonra tekrar deneyebilirsiniz.</p>
        </div>
    </div>
</div>
@endsection
