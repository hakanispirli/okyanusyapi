...
<section class="relative overflow-hidden bg-corporate-900" x-data="heroSlider()" x-init="init()">
    <!-- Slider Container -->
    <div class="relative h-[calc(100vh-4rem)] sm:h-[calc(100vh-5rem)] min-h-[600px]">
        ...
        <template x-for="(slide, index) in slides" :key="slide.id">
            <div x-show="currentSlide === index" x-transition:enter="transition-opacity ease-out duration-700"
                ...
                <div class="absolute inset-0">
                    ...
                    <!-- Gradient Overlay -->
                    <div
                        class="absolute inset-0 bg-gradient-to-r from-corporate-900/95 via-corporate-900/80 to-corporate-900/60">
                    </div>
                    <div class="absolute inset-0 bg-gradient-to-t from-corporate-900/90 via-transparent to-transparent">
                    </div>
                </div>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div class="max-w-3xl">
                            ...
                            <div x-show="currentSlide === index"
                                ...
                                x-transition:enter-end="opacity-100 translate-y-0" class="mb-4">
                                <span
                                    class="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 backdrop-blur-sm border border-primary-400/30 rounded-full text-primary-300 text-sm font-medium tracking-wide">
                            ...
                            <p x-show="currentSlide === index"
                                ...
                                x-transition:enter-start="opacity-0 translate-y-4"
                                x-transition:enter-end="opacity-100 translate-y-0"
                                class="text-lg sm:text-xl text-gray-300 mb-8 max-w-2xl font-light leading-relaxed"
                            ...
                            <div x-show="currentSlide === index"
                                ...
                                <a :href="slide.ctaSecondary.link"
                                    class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-xl font-semibold tracking-tight hover:bg-white/20 hover:border-white/30 transition-all duration-300">
        ...
        <div class="absolute bottom-8 right-8 hidden lg:block z-10">
            <a href="#features"
                class="flex flex-col items-center gap-2 text-white/60 hover:text-white transition-colors duration-300 group">
                <span class="text-xs font-medium tracking-wider uppercase">Keşfet</span>
                <div
                    class="w-6 h-10 border-2 border-white/30 rounded-full flex items-start justify-center p-1 group-hover:border-white/60 transition-colors duration-300">
