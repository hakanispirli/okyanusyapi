    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Yeni bir blog yazısı oluşturun</p>
            </div>
    ...
    <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}"
                        ...
                        placeholder="Örn: Konut İnşaatında Dikkat Edilmesi Gerekenler" required>
                    @error('title')
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="excerpt" name="excerpt" rows="3"
                        ...
                        placeholder="Blog yazısının kısa özeti...">{{ old('excerpt') }}</textarea>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <div>
                ...
                <x-quill-editor name="content" :value="old('content')" placeholder="Blog yazınızın detaylı içeriğini yazın..."
                    height="500px" toolbar="full" :required="true" class="mb-2" />
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <div x-data="heroImageUpload()">
                <label for="featured_image" class="block text-sm font-medium text-gray-700 mb-2">
                    Kapak Resmi <span class="text-red-500">*</span>
                </label>
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="featured_image"
                                ...
                                <span>Kapak resmini yükleyin</span>
                        ...
                        <p class="text-xs text-gray-500">
                            PNG, JPG, WebP formatları desteklenir. Maksimum 2MB.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="gallery_images"
                                ...
                                <input id="gallery_images" name="gallery_images[]" type="file" accept="image/*"
                                    multiple @change="handleFiles($event)" class="sr-only">
                            </label>
                            <p class="pl-1">veya sürükleyip bırakın</p>
                        </div>
                        <p class="text-xs text-gray-500">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="meta_description" name="meta_description" rows="3" maxlength="160"
                        ...
                        placeholder="SEO için açıklama (maksimum 160 karakter)">{{ old('meta_description') }}</textarea>
