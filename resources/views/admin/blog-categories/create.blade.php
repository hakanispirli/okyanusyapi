<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Yeni Blog Kategorisi</h2>
                <p class="mt-1 text-sm text-gray-600">Yeni bir blog kategorisi oluşturun</p>
            </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="mt-6">
                                ...
                                <textarea id="description"
                                          ...
                                          placeholder="Kategori hakkında kısa bir açıklama...">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="meta_description"
                                              ...
                                              placeholder="SEO için açıklama">{{ old('meta_description') }}</textarea>
