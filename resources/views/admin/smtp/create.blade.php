<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Yeni SMTP Ayarı Oluştur</h1>
                <p class="mt-1 text-sm text-gray-600">E-posta gönderimi için yeni SMTP ayarı ekleyin</p>
            </div>
    ...
    <form method="POST" action="{{ route('admin.smtp.store') }}" class="space-y-8">
        @csrf
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="port" name="port" value="{{ old('port', 587) }}"
                ...
                <div>
                    ...
                    <select id="encryption" name="encryption"
                        ...
                        <option value="null" {{ old('encryption') == 'null' ? 'selected' : '' }}>Yok</option>
                    </select>
                    @error('encryption')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                        ...
                        placeholder="Bu SMTP ayarı için açıklama yazın...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
